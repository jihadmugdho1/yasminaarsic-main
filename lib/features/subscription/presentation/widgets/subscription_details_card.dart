...
class SubscriptionDetailsCard extends StatelessWidget {
  ...
  Widget _buildPromoCodeInputWidget({
    required LocalizationController locale,
    String labelText = 'Have a Promo Code?',
    String hintText = 'Enter promo code',
    String applyButtonText = 'Apply',
    Color labelColor = Colors.black87,
    Color hintTextColor = Colors.grey,
    Color applyButtonColor = const Color(0xFF6C63FE),
    Color applyTextColor = Colors.white,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(Icons.local_offer_outlined, size: 20.sp, color: labelColor),
              SizedBox(width: 8.w),
              Text(
                labelText,
                style: TextStyle(
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: const Color(0xFFF3F3F5), // Light gray background
                    border: InputBorder.none, // ✅ REMOVES BLACK BORDER OUTLINE
                  ...
                  style: TextStyle(
                    fontSize: 16.sp,
                  ), // Optional: for consistent text size
                ),
              ),
              SizedBox(width: 8.w),
              FilledButton(
